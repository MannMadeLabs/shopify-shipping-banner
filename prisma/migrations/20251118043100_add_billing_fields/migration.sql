...
INSERT INTO "new_AppSettings" ("backgroundColor", "belowThresholdMessage", "createdAt", "curatedProductIds", "enableAnalytics", "freeShippingThreshold", "id", "progressColor", "qualifiedMessage", "shop", "showUpsell", "textColor", "updatedAt", "upsellProductCount", "upsellSource", "upsellTitle") SELECT "backgroundColor", "belowThresholdMessage", "createdAt", "curatedProductIds", "enableAnalytics", "freeShippingThreshold", "id", "progressColor", "qualifiedMessage", "shop", "showUpsell", "textColor", "updatedAt", "upsellProductCount", "upsellSource", "upsellTitle" FROM "AppSettings";
